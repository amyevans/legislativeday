!function ($) {
  ...
  var bEvent = function () {
    ...
    function googleMap() {
      var ourAddress = $("#hotel").data("location") || "earth";
    ...
    $.formUtils.addValidator({
      ...
      validatorFunction : function(value, $el, config, language, $form) {
        ...
        if (value === 'EXEC' || value === 'PASTPRES' || value === 'YAT' || value === 'EARLYBIRD' || value === 'SUPEREARLY') {
          return true;
        } else {
          return false;
        }
      ...
      $.validate({
        ...
        onSuccess: function () {
          var name = $("#regName").val(),
            ...
            yr = $("#regYr").val(),
            coup = $("#regCoup").val(),
            allData = 'name=' + name + '&email=' + email + '&phone=' + phone + '&plan=' + plan + '&mo=' + mo + '&yr=' + yr + '&coup=' + coup;
          $.ajax({
            type: "POST",
